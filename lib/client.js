...
var MODEL_ENTRIES = [
  {
    ...
    fields: [
      ...
      },
      {
        ...
        effect: "session",
        label: "\u9ED8\u8BA4\u4E0A\u4E0B\u6587\u7A97\u53E3\uFF08token\uFF09",
        help: "\u6A21\u578B\u76EE\u5F55\u6CA1\u58F0\u660E\u7A97\u53E3\u65F6\u7528\u5B83\uFF0C\u4E0A\u4E0B\u6587\u5360\u7528\u7EDF\u8BA1\u4E5F\u6309\u5B83\u7B97\u3002\u5DF2\u5F00\u7684\u4F1A\u8BDD\u6CBF\u7528\u6253\u5F00\u65F6\u7684\u7A97\u53E3\u3002"
      },
      {
...
function installChatHistory(sessions) {
  let disposed = false;
  ...
  const unsubscribe = typeof subscription === "function" ? subscription : subscription !== null && typeof subscription === "object" && typeof subscription.dispose === "function" ? () => subscription.dispose() : null;
